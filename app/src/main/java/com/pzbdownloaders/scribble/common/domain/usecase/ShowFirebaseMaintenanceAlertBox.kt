package com.pzbdownloaders.scribble.common.domain.usecase
...
@Composable
fun ShowFIrebaseMaintenanceAlertBox(
    ...
    LaunchedEffect(Unit) {
        ...
        var document = firestore.collection("AlertBoxes").document("BackendMaintenance")
